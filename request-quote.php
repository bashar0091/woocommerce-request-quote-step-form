            ...
            <div class="step_1">
                ...
                <div class="car_wrapper_list">
                    ...
                    <div class="car_wrapper_item">
                        <div class="car_image">
                            <img src="./img/bus1-background-removed@2x.png" alt="car">
                        </div>
                        <h3 class="heading_3">Mercedes-Benz Sprinter</h3>
                        <div class="counter_wrapper">
                            ...
                            <input type="text" value="0" class="number_"> 
                            <div class="plus_">
                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 14 14" fill="none">
            ...
            <div class="step_3">
                ...
                <div>
                    <div class="note_">
                        ...
                        <input type="text" name="" id="" placeholder="Bedrijfsnaam">
                    </div>
                    ...
                    <div class="note_2col">
                        <div class="note_">
                            ...
                            <input type="text" name="" id="" placeholder="KVK nummer">
                        </div>
                        <div class="note_">
                            <label for="">
                                BTW nummer
                            </label>
                            <input type="text" name="" id="" placeholder="BTW nummer">
                        </div>
                    </div>
                    ...
                    <div class="note_2col">
                        ...
                        <div class="note_">
                            ...
                            <input type="text" name="" id="" placeholder="Huisnummer en toevoeging">
                        </div>
                    </div>
                    ...
                    <div class="note_2col">
                        <div class="note_">
                            ...
                            <input type="text" name="" id="" placeholder="Straatnaam">
                        </div>
                        <div class="note_">
                            <label for="">
                                Plaats
                            </label>
                            <input type="text" name="" id="" placeholder="Plaats">
                        </div>
                    </div>
                ...
                <div>
                    <div class="note_2col">
                        ...
                        <div class="note_">
                            ...
                            <input type="text" name="" id="" placeholder="Tussenvoegsel">
                        </div>
                        <div class="note_">
                            <label for="">
                                Achternaam
                            </label>
                            <input type="text" name="" id="" placeholder="Achternaam">
                        </div>
                    </div>
                ...
                <button type="submit" class="step_btn">
                    Offerte aanvragen
                </button>
